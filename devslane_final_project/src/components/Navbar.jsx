...
import { withCart, withUser, withAlert } from './withProvider';

function Navbar({user, setUser, totalQuantity, setAlert }) {
...
export default withUser(withAlert(withCart(Navbar)));